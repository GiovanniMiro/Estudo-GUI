...
def pesquisarItem():
    ...
    #Instaciando da classe Options para configurar o headless
    opcoes = Options()
    ...
    valorMoeda.config(text="\n\n" + str(moedaSelecionada.get()) + ":" + valorDolarGoogle + "\n\n")
#---------------------------------------------------------------------------------------
root = Tk()
root.title("Cotação")

Label(root, text="Moeda: ", font="Arial 30").grid(row=0, column=0)

moedaSelecionada = ttk.Combobox(root, font="Arial 30")
...
valorMoeda = Label(root, text="Valor: 0", font="Arial 40")
